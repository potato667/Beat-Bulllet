...
{
    public partial class Beats : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public string EditModeType { get; set; } = "Beat_Bullet.Entities.Beats";
        protected FlatRedBall.Graphics.Layer LayerProvidedByContainer = null;
        public Beats () 
        	: this(FlatRedBall.Screens.ScreenManager.CurrentScreen.ContentManagerName, true)
        {
        }
        public Beats (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Beats (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void PostInitialize () 
        {
            ...
            CircleInstance.Radius = 32f;
            CircleInstance.Color = Microsoft.Xna.Framework.Color.SpringGreen;
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("BeatsStaticUnload", UnloadStaticContent);
